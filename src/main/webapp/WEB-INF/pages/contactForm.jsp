...
<body>
	...
	$('#btnSave').click(function (e) {
	    ...
	    if (json.contactid=="0"){
	        $.ajax({
	            url: "http://localhost:8080/SalesDiaryPro/contact/create",
	            type: 'POST',
	            ...
	            success:function(data, Textstatus, jqXHR){
	                ...
	                window.location.href = "/SalesDiaryPro/listContact";
	            },
	        ...
	        $.ajax({
	            url: "http://localhost:8080/SalesDiaryPro/contact/update/"+contactid,
	            type: 'POST',
	            contentType: "application/json",
	            dataType: "json",
	            data: JSON.stringify(json),
