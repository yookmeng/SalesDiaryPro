...
<body>
		...
		<table class="table">
       	...
       	<div align="center">
			<div class="box box-color box-bordered">
				<div class="box-title">
					<h3>${branchTarget.branchname} ${branchTarget.period} Monthly Summary</h3>
				</div>
	...
	$(document).ready(function() {
		if ($(".usertable").length > 0) {
            ...
            sDom: "lfrtip",
            aoColumnDefs: [{ bSortable: !1, aTargets: [0, 14]}]
			};
	        ...
	        d.columnFilter({
	            ...
	            aoColumns: [null, { type: "text" }, { type: "text" }, null, null, null, null, null, null, null, null, null, { type: "text" }, {type: "text" }, null]
	        });
		};
	})
	</script> 
